...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7790292955').split()] # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002081769869') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None

# This Channel Is For When User Request Any File Name With command or hashtag like - /request or #request
reqst_channel = environ.get('REQST_CHANNEL', '-1002255995778')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://fofete7368:dPbnkuAeaUW7KdOp@alexa.gylmvja.mongodb.net/?retryWrites=true&w=majority&appName=Alexa")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "fofete7368")
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://envs.sh/e4A.jpg') # payment code picture url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/MOVIE_GR0UP')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/MOVIES_HD_STORE')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/MOVIE_GR0UP') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/ll_Alexa_owner_ll')
...
VERIFY_SHORTLINK_API = environ.get('VERIFY_SHORTLINK_API', 'a26a28ac39746303ee837930f2438cd2397c5aa3')
